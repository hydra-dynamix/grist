...
fn extension_identity(extension: &str) -> Option<(&'static str, &'static str)> {
    Some(match extension {
        ...
        "bmp" => ("bmp", "image/bmp"),
        "heif" | "heic" | "avif" => ("heif", "image/heif"),
        "svg" => ("svg", "image/svg+xml"),
        "mp3" => ("mp3", "audio/mpeg"),
        "mp4" | "m4a" | "m4v" => ("mp4", "video/mp4"),
        "mov" | "qt" => ("quicktime", "video/quicktime"),
        "wav" => ("wav", "audio/wav"),
        "flac" => ("flac", "audio/flac"),
        "mkv" | "mka" | "webm" => ("matroska", "video/x-matroska"),
...
fn media_type_identity(media_type: &str) -> Option<(&'static str, &'static str)> {
    Some(match media_type {
        ...
        "image/heif" | "image/heic" | "image/avif" => ("heif", "image/heif"),
        "image/svg+xml" => ("svg", "image/svg+xml"),
        "image/x-ms-bmp" => ("bmp", "image/bmp"),
        "audio/mpeg" | "audio/mp3" => ("mp3", "audio/mpeg"),
        "video/mp4" | "audio/mp4" => ("mp4", "video/mp4"),
        "video/quicktime" => ("quicktime", "video/quicktime"),
        "audio/wav" | "audio/wave" | "audio/x-wav" => ("wav", "audio/wav"),
        "audio/flac" | "audio/x-flac" => ("flac", "audio/flac"),
...
fn format_for_kind(kind: &ContentKind) -> Option<&'static str> {
    Some(match kind {
        ...
        ContentKind::Bmp => "bmp",
        ContentKind::Heif => "heif",
        ContentKind::Svg => "svg",
        ContentKind::Mp3 => "mp3",
        ContentKind::Mp4 => "mp4",
        ContentKind::QuickTime => "quicktime",
        ContentKind::Wav => "wav",
        ContentKind::Flac => "flac",
        ContentKind::Matroska => "matroska",
...
fn content_kind_for_format(format: &str) -> ContentKind {
    match normalize_format(format).as_str() {
        ...
        "bmp" => ContentKind::Bmp,
        "heif" | "heic" | "avif" => ContentKind::Heif,
        "svg" => ContentKind::Svg,
        "mp3" | "mpeg_audio" => ContentKind::Mp3,
        "mp4" | "m4a" | "m4v" => ContentKind::Mp4,
        "quicktime" | "mov" => ContentKind::QuickTime,
        "wav" | "wave" => ContentKind::Wav,
        "flac" => ContentKind::Flac,
        "matroska" | "mkv" | "webm" => ContentKind::Matroska,
